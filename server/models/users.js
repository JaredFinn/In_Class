...
const list = [
    {
        ...
        password: '$2b$08$XzJjlPTrxrXJnVmP1yBHsOY2qAReUwCSUTYHq/4wZg/hFV8Twy42W',
        isAdmin: true,
...
module.exports.LoginFB = async (access_token) => {
    ...
    const userFB = await axios.get(`http://graph.facebook.com/v10.0/me?fields=first_name,last_name,email,picture&access_token=${access_token}`)
    console.log(userFB.data);

    //GET A VERIFIED EMAIL FROM FACEBOOK
